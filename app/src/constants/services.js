...
export const SERVICE_CATALOG = [
    ...
    { id: 'dropbox', name: 'Dropbox', icon: Database, color: 'text-indigo-500', desc: 'Sincronização de ficheiros' },
    { id: 'aws-s3', name: 'AWS S3', icon: Server, color: 'text-orange-500', desc: 'Object storage para developers' },
];
